 ...
 * 
 */
public class Waibaoba implements PageProcessor, Runnable {
  private String seedUrl = "http://www.waibaoba.com/";
  private String siteNmae = "中国软件外包平台";
  ...
  public static void main(String[] args) {
    ...
    Spider.create(new Waibaoba()).addUrl("http://www.waibaoba.com/").thread(5).run();
  }
  ...
  public void run() {
    ...
    localurl = pro.getProperty("LOCALURL");
    StopDeepStr = pro.getProperty("DEEP");
    Spider.create(new Waibaoba()).addPipeline(new MysqlPipeline())
        .addUrl("http://www.waibaoba.com/").thread(5).run();
  }
