 ...
 */
public class Enet implements PageProcessor, Runnable {
  private String seedUrl = "http://www.enet.com.cn/";
  private String siteNmae = "eNet硅谷动力";
  ...
  public static void main(String[] args) {
    ...
    Spider.create(new Enet())
    // .addPipeline(new FilePipeline("D:\\test1"))
    // .addPipeline(new JDBCPipeline())
    // .addPipeline(new mysqlPipeline())
        .addUrl("http://www.enet.com.cn/article/2014/1223/A20141223431574.shtml").thread(5).run();
  }
  ...
  public void run() {
    ...
    localurl = pro.getProperty("LOCALURL");
    StopDeepStr = pro.getProperty("DEEP");
    Spider.create(new Enet()).addPipeline(new MysqlPipeline()).addUrl("http://www.enet.com.cn/")
        .thread(10).run();
  }
