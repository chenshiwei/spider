...
public class Page {
     ...
     * @param requests
     */
    public void addTargetRequests(List<String> requests,int deep) {
        synchronized (targetRequests) {
            for (String s : requests) {
                ...
                targetRequests.add(new Request(s,deep));
            }
        }
    }
     ...
     * @param requests
     */
    public void addTargetRequests(List<String> requests, long priority,int deep) {
        synchronized (targetRequests) {
            for (String s : requests) {
                if (StringUtils.isBlank(s) || s.equals("#") || s.startsWith("javascript:")) {
                    continue;
                ...
                s = UrlUtils.canonicalizeUrl(s, url.toString());
                targetRequests.add(new Request(s,deep).setPriority(priority));
            }
        }
    }
     ...
     * @param requestString
     */
    public void addTargetRequest(String requestString,int deep) {
        if (StringUtils.isBlank(requestString) || requestString.equals("#")) {
            return;
        }
        synchronized (targetRequests) {
            requestString = UrlUtils.canonicalizeUrl(requestString, url.toString());
            targetRequests.add(new Request(requestString,deep));
        }
    }
