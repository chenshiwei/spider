...
public class BloomFilterDuplicateRemoverTest {
    ...
    public void testRemove() throws Exception {
        ...
        boolean isDuplicate = bloomFilterDuplicateRemover.isDuplicate(new Request("a",1), null);
    ...
    public void testMemory() throws Exception {
        ...
        for (int i = 0; i < times; i++) {
            duplicateRemover.isDuplicate(new Request(String.valueOf(i),1), null);
        }
    ...
    public void testMissHit() throws Exception {
        ...
        int missCheck = 0;
        for (int i = 0; i < times; i++) {
            boolean duplicate = duplicateRemover.isDuplicate(new Request(String.valueOf(i),1), null);
            if (duplicate) {
                wrong++;
            } else {
                right++;
            }
            duplicate = duplicateRemover.isDuplicate(new Request(String.valueOf(i),1), null);
            if (!duplicate) {
                missCheck++;
            }
        }
