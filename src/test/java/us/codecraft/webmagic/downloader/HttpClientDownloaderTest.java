...
public class HttpClientDownloaderTest {
    ...
    public void testCookie() {
        ...
        Page download = httpClientDownloader.download(new Request("http://www.diandian.com",1), site.toTask());
    ...
    public void testCycleTriedTimes() {
        ...
        Request request = new Request("http://localhost/404",2);
    ...
    public void testGetHtmlCharset() throws Exception {
        ...
        Runner.running(server, new Runnable() {
            ...
            private String getCharsetByUrl(String url) {
                ...
                Request requestGBK = new Request(url,1);
