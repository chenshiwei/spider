...
public class Ccidcom implements PageProcessor, Runnable {

  private String seedUrl = "http://www.ccidcom.com";
  private String siteNmae = "通信产业网";
  ...
  public void process(Page page) {
    ...
    if (PageUrl.matches("http://www.ccidcom.com/html/[a-z]*/\\d*/[\\d-]*.html")) {
  ...
  private static Result getDocument(Result rs, String html) {
    ...
    Elements Title = doc.select("div.pagetit");
    String title = Title.text();
    rs.setTitle(title);

    Elements Content = doc.select("div.pagetxt");
    ...
    String time = doc.select("div[class=url] > span").get(2).text();
  ...
  public static void main(String[] args) {
    ...
    // TODO Auto-generated method stub
    Spider.create(new Ccidcom()).addUrl("http://www.ccidcom.com")
  ...
  public void run() {
    ...
    StopDeepStr = pro.getProperty("DEEP");
    // TODO Auto-generated method stub
    Spider.create(new Ccidcom()).addUrl("http://www.ccidcom.com").addPipeline(new MysqlPipeline())
        .thread(5).run();
